...
public class ViewActivityWorkAdd extends Activity implements OnClickListener, OnItemSelectedListener {
	...
	private int tr = 0;
	private String h, m, na, st, et, pp, mx, th, sm;
	...
	private void findViewById() {
		...
		thour = (EditText) findViewById(R.id.wa_time);
		sum = (EditText) findViewById(R.id.wa_sum);
	...
	private boolean chk(TextView a, int b) {
		...
		if (s.length() != 0) {
			...
			case 0:
				...
				break;
			case 1:
				st = s.substring(0, 2) + s.substring(3, 5);
				break;
			case 2:
				et = s.substring(0, 2) + s.substring(3, 5);
				break;
			case 3:
				pp = s;
				break;
