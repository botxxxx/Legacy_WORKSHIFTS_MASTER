...
public class MoreActivity extends Activity implements OnClickListener, OnLongClickListener, OnItemClickListener,
		OnItemLongClickListener, OnPageChangeListener {
	private boolean res = false, wb = false, ub = false;
	...
	public static ArrayList<View> workView = new ArrayList<View>();
	public static ArrayList<View> userView = new ArrayList<View>();
				...
				new AlertDialog.Builder(this).setTitle("捨棄自動排班暫存?")
						.setPositiveButton("否", new DialogInterface.OnClickListener() {
							...
							public void onClick(DialogInterface arg0, int arg1) {
								...
								MainActivity.out("g1/" + MainActivity.getSQLdate());
								startActivity(new Intent(MoreActivity.this, ViewActivityWorkAdd.class));
							}
						}).show();
			} else {
				...
				new AlertDialog.Builder(this).setTitle("捨棄自動排班暫存?")
						.setPositiveButton("否", new DialogInterface.OnClickListener() {
							...
							public void onClick(DialogInterface arg0, int arg1) {
								MainActivity.g9 = false;
								MainActivity.out("g1/" + MainActivity.getSQLdate());
								startActivity(new Intent(MoreActivity.this, ViewActivityUserAdd.class));
							}
						}).show();
			} else {
	...
	private void cleanMonth() {
		if (MainActivity.getlink()) {
			if (!MainActivity.getupdate()) {
				if (MainActivity.getReser()) {
					new AlertDialog.Builder(this).setTitle("此功能將清除當月份所有排班與約班紀錄")
							.setPositiveButton("否", new DialogInterface.OnClickListener() {
								public void onClick(DialogInterface arg0, int arg1) {
								}
							}).setNegativeButton("是", new DialogInterface.OnClickListener() {
	...
	private void view_0() {
		...
		w_menu.setOnLongClickListener(this);
	...
	private void view_1() {
		...
		u_menu.setOnLongClickListener(this);
				...
				new AlertDialog.Builder(this).setTitle("捨棄自動排班暫存?")
						.setPositiveButton("否", new DialogInterface.OnClickListener() {
							...
							public void onClick(DialogInterface arg0, int arg1) {
								...
								item = position;
								if (page == 0) {
									startActivity(new Intent(MoreActivity.this, ViewActivityWorkMore.class));
								} else {
									startActivity(new Intent(MoreActivity.this, ViewActivityUserMore.class));
								}
							}
						}).show();
			} else {
